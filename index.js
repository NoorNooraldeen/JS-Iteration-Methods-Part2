...
/***********************
       ...
       **********************/
const incomeTranscation = transactions.filter(
  (transaction) => transaction[0] === "income"
);
console.log(incomeTranscation);

const expensTranscation = transactions.filter(
  (transaction) => transaction[0] === "expense"
);
console.log(expensTranscation);
/***********************
       ...
       **********************/
const totalIncome = incomeTranscation.reduce(
  (sum, transaction) => sum + transaction[1],
  0
);
console.log(totalIncome);

const totalExpenses = expensTranscation.reduce(
  (sum, transaction) => sum + transaction[1],
  0
);
...
const aboveOrEquel = transactions.filter(
  (transaction) => transaction[1] >= 500
);
console.log(aboveOrEquel);
